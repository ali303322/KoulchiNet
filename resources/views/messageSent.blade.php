<div class="flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-100 to-gray-300">
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-lg text-center">
        ...
        {{-- Email Body --}}
        <h5 class="text-gray-700 text-sm mb-6">Bonjour {{ $mailData['clientName'] }},</h5>

        <div class="mt-6 border-t border-gray-200 pt-4 text-left">
            <p>Votre demande de service a été envoyée à {{ $mailData['prestataireName'] }} {{ $mailData['prestatairePrenom'] }}.
                Vous pouvez contacter le prestataire directement dans la platform</p>
        </div>
